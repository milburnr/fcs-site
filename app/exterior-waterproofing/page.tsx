        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none text-gray-600">
              ...
              <p>
                As a prime general contractor—never a subcontractor—we maintain complete project accountability from initial consultation through final completion. This direct control ensures quality waterproofing installations that meet the demanding requirements of Florida's subtropical climate. Our in-house engineering capabilities, combined with partnerships with premium manufacturers like Sika, BASF, Tremco, and Carlisle, enable us to design and install waterproofing systems tailored to each project's specific requirements.
              </p>
              <p>
