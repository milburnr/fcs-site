      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          <div className="grid md:grid-cols-2 gap-8">
            <RelatedServices city="St. Petersburg" currentService="disaster-recovery" />
            <NearbyLocations currentCity="St. Petersburg" service="disaster-recovery" serviceName="Disaster Recovery" />
          </div>
        </div>
      </section>
