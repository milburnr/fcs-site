...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Commercial construction in Brandon FL by Florida Construction Specialists. SR 60 corridor retail, office buildings, distribution centers near I-75.",
    url: "https://floridaconstructionspecialists.com/commercial-construction-brandon/",
    type: "website",
  ...
  return (
    <>
      ...
      <section className="relative py-20 bg-gradient-to-br from-brand-green-dark via-brand-green-forest to-brand-green-dark overflow-hidden">
        <div className="absolute inset-0 bg-[url('/images/lions-world-vision-institute-building-exterior/lions-world-vision-institute-building-exterior-large.webp')] bg-cover bg-center opacity-20" />
      ...
      {/* Internal Links */}
      <RelatedServiceLocations currentCity="Brandon" currentService="commercial-construction" currentServiceName="Commercial Construction" />
    ...
    <RelatedArticles pageSlug="commercial-construction-brandon" />
    </>
  );
}
