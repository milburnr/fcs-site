...
export const metadata: Metadata = {
  title: "Factors Influencing Commercial Construction Project timeline - Florida Construction Specialists",
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto prose prose-lg">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Factors impacting the duration of a commercial construction project in Florida
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Effect of the construction phase on project duration
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Minimizing or avoiding construction delays in Tampa area commercial projects
              </h2>
              <p className="text-gray-600 mb-6">
