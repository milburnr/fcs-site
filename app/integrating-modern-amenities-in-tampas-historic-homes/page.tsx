...
export const metadata: Metadata = {
  title: "Integrating Modern Amenities in Tampa&apos;s Historic Homes - Florida Construction Specialists",
  description: "Integrating modern amenities in Tampa&apos;s historic homes without compromising charm. Discover tips for contemporary upgrade and enhance your historic property.",
};
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="container-custom text-center text-white relative z-10">
          ...
          <p className="text-xl max-w-3xl mx-auto text-gray-200">
            Integrating modern amenities in Tampa&apos;s historic homes without compromising charm. Discover tips for contemporary upgrade and enhance your historic pr
          </p>
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto prose prose-lg">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Preserving the Past Integrating Modern Amenities in Tampas Historic Homes
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Blending Old and New Strategies for Updating Tampas Historic Homes
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Designing with History Incorporating Modern Upgrades in Historic Properties
              </h2>
              <p className="text-gray-600 mb-6">
