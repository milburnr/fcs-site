...
export default function InsuranceRestorationSarasotaPage() {
  return (
    <>
      ...
      {/* Internal Links */}
      <RelatedServiceLocations currentCity="Sarasota" currentService="insurance-restoration" currentServiceName="Insurance Restoration" />
    ...
    <RelatedArticles pageSlug="insurance-restoration-sarasota" />
    </>
  );
}
