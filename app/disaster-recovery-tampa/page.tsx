...
export default function DisasterRecoveryTampaPage() {
  return (
    <>
      ...
      {/* Internal Links */}
      <RelatedServiceLocations currentCity="Tampa" currentService="disaster-recovery" currentServiceName="Disaster Recovery" />
    ...
    <RelatedArticles pageSlug="disaster-recovery-tampa" />
    </>
  );
}
