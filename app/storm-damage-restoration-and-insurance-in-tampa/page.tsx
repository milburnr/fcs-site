...
export const metadata: Metadata = {
  title: "Storm Damage Restoration and Insurance in Tampa - Florida Construction Specialists",
...
const breadcrumbItems = [
  { name: "Home", href: "/" },
  { name: "Storm Damage Restoration and Insurance in Tampa", href: "/storm-damage-restoration-and-insurance-in-tampa/" },
];
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="container-custom text-center text-white relative z-10">
          ...
          <p className="text-xl max-w-3xl mx-auto text-gray-200">
            Top-rated storm damage restoration and insurance claim assistance in Tampa. Trust our experts for efficient storm damage repair and navigation of insu
          </p>
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto prose prose-lg">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Understanding the Storm Damage Restoration Process in Tampa
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Dealing with Storm Damage Restoration in Tampa Key Steps
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Insurance Claims for Storm Damage Restoration in Tampa What You Need to Know
              </h2>
              <p className="text-gray-600 mb-6">
