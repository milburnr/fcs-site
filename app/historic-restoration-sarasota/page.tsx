...
export const metadata: Metadata = {
  ...
  title: "Historic Restoration Sarasota | Mediterranean Revival",
  description: "Historic restoration in Sarasota by Florida Construction Specialists. Burns Court, Laurel Park, Mediterranean Revival architecture, Ringling-era estates.",
  openGraph: {
    title: "Historic Restoration Sarasota | Mediterranean Revival",
    description: "Historic restoration in Sarasota by Florida Construction Specialists. Burns Court, Laurel Park, Mediterranean Revival architecture, Ringling-era estates.",
    url: "https://floridaconstructionspecialists.com/historic-restoration-sarasota/",
    type: "website",
...
export default function HistoricRestorationSarasotaPage() {
  return (
    <>
      ...
      {/* Internal Links */}
      <RelatedServiceLocations currentCity="Sarasota" currentService="historic-restoration" currentServiceName="Historic Restoration" />
    ...
    <RelatedArticles pageSlug="historic-restoration-sarasota" />
    </>
  );
}
