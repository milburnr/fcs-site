...
export const metadata: Metadata = {
  title: "Claims Negotiation for Property Damage in Tampa - Florida Construction Specialists",
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto prose prose-lg">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Negotiating Insurance Claims for Property Damage in Tampa
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Effective Strategies for Insurance Claims in Tampa
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Strategies for Property Damage Insurance Claims in Tampa
              </h2>
              <p className="text-gray-600 mb-6">
