...
export const metadata: Metadata = {
  title: "Emergency Response for Insurance Restoration in Tampa - Florida Construction Specialists",
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto prose prose-lg">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                How can affected residents and businesses quickly restore their properties
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Disaster Recovery for Property Damage in Tampa
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Restoration Contractors for Emergency Repairs in Tampa
              </h2>
              <p className="text-gray-600 mb-6">
