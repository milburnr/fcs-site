...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://floridaconstructionspecialists.com/top-commercial-contractors-in-tampa/",
    type: "website",
...
const internalLinks = [
  ...
  { href: "/commercial/guides/hire-licensed-contractors-for-commercial-construction-project/", label: "Licensing Requirements" },
...
export default function Page() {
  return (
    ...
    <RelatedArticles pageSlug="top-commercial-contractors-in-tampa" />
    </>
  );
}
