...
export default function DisasterRecoveryBrandonPage() {
  return (
    <>
      ...
      {/* Internal Links */}
      <RelatedServiceLocations currentCity="Brandon" currentService="disaster-recovery" currentServiceName="Disaster Recovery" />
    ...
    <RelatedArticles pageSlug="disaster-recovery-brandon" />
    </>
  );
}
