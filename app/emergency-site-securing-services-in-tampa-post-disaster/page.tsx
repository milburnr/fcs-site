...
export const metadata: Metadata = {
  title: "Emergency Site Securing Services in Tampa Post-Disaster - Florida Construction Specialists",
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto prose prose-lg">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Immediate response for securing sites in Tampa after a natural disaster
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Disaster recovery strategies for business owners and industrial site managers in Tampa
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Essential steps for emergency preparedness in postdisaster situations
              </h2>
              <p className="text-gray-600 mb-6">
