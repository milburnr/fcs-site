...
export const metadata: Metadata = {
  title: "Tampa&apos;s Awards for Historic Restoration Excellence - Florida Construction Specialists",
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto prose prose-lg">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Tampa’s Heritage Conservation Achievement Recognizing Excellence in Historic Restoration
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Architectural Restoration Accolades in Tampa Celebrating Preservation Excellence
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Restoration Honors in Tampa Showcasing Excellence in Historic Renovation
              </h2>
              <p className="text-gray-600 mb-6">
