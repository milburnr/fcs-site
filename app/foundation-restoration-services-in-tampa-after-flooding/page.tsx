...
export const metadata: Metadata = {
  title: "Foundation Restoration Services in Tampa After Flooding - Florida Construction Specialists",
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto prose prose-lg">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Assessing Structural Damage Understanding Flooding Impact on Tampa Homes and Buildings
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Importance of Foundation Repair Restoring Stability and Structural Integrity
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Water Damage Restoration Addressing and Repairing Foundation Problems in Buildings
              </h2>
              <p className="text-gray-600 mb-6">
