...
export const metadata: Metadata = {
  title: "Tampa Commercial Property Disaster Recovery Services - Florida Construction Specialists",
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto prose prose-lg">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Essential services for commercial property recovery in Tampa after disasters
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Benefits of property rehabilitation for business owners in Tampa
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Importance of emergency repairs for commercial properties in Tampa
              </h2>
              <p className="text-gray-600 mb-6">
