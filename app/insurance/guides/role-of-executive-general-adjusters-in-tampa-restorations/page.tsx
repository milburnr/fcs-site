...
const breadcrumbItems = [
  ...
  { name: "Role of Executive General Adjusters in Tampa Restorations", href: "/insurance/guides/role-of-executive-general-adjusters-in-tampa-restorations/" },
];
...
export default function Page() {
  return (
    <>
      ...
      {/* Final CTA */}
            <GuideCTA silo="insurance" heading="Expert Support for Large Loss Claims" />
    </>
  );
}
