...
const breadcrumbItems = [
  ...
  { name: "Milestone Inspection Requirements", href: "/insurance/guides/milestone-inspection-requirements/" },
];
  ...
  return (
    <>
      ...
      <ArticleSchema
        ...
        slug="/insurance/guides/milestone-inspection-requirements/"
      />
      <FAQSchema faqs={faqs} />
      ...
      <Breadcrumb
        items={[
          ...
          { name: "Milestone Inspections", href: "/insurance/guides/milestone-inspection-requirements/" },
        ]}
      />
