...
const breadcrumbItems = [
  ...
  { name: "Tampa's Disaster Related Demolition Services", href: "/insurance/guides/tampas-disaster-related-demolition-services/" },
];
...
export default function Page() {
  return (
    <>
      ...
      <ArticleSchema
        headline="Tampa Disaster Demolition | Emergency Commercial"
        description="Professional disaster-related demolition services in. Expert tips from Florida Construction Specialists, licensed CBC. Call (813) 420-7561 for a quote."
        datePublished="2024-01-01"
        slug="/insurance/guides/tampas-disaster-related-demolition-services/"
      />
      <FAQSchema faqs={faqs} />
