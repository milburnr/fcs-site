...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://floridaconstructionspecialists.com/insurance/guides/structural-integrity-evaluation-in-tampa-post-disaster/",
    type: "website",
...
const breadcrumbItems = [
  ...
  { name: "Structural Integrity Evaluation in Tampa Post-Disaster", href: "/insurance/guides/structural-integrity-evaluation-in-tampa-post-disaster/" },
];
...
export default function Page() {
  return (
    <>
      ...
      {/* Final CTA */}
            <GuideCTA silo="insurance" heading="Tampa Bay Structural Engineering Experts" />
    </>
  );
}
