...
const breadcrumbItems = [
  ...
  { name: "Tampa's Building Codes for Insurance Restoration", href: "/insurance/guides/tampas-building-codes-for-insurance-restoration/" },
];
...
export default function Page() {
  return (
    <>
      ...
      {/* Final CTA */}
            <GuideCTA silo="insurance" heading="Building Code Expertise for Your Restoration" />
    </>
  );
}
