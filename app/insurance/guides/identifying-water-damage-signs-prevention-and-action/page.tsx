...
const breadcrumbItems = [
  ...
  { name: "Identifying Water Damage Signs, Prevention and Action", href: "/insurance/guides/identifying-water-damage-signs-prevention-and-action/" },
];
...
export default function Page() {
  return (
    <>
      ...
      {/* Final CTA */}
            <GuideCTA silo="insurance" heading="Tampa Bay Water Damage Experts" />
    </>
  );
}
