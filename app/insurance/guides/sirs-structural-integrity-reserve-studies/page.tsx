...
const breadcrumbItems = [
  ...
  { name: "Sirs Structural Integrity Reserve Studies", href: "/insurance/guides/sirs-structural-integrity-reserve-studies/" },
];
  ...
  return (
    <>
      ...
      <ArticleSchema
        ...
        slug="/insurance/guides/sirs-structural-integrity-reserve-studies/"
      />
      <FAQSchema faqs={faqs} />
      ...
      <Breadcrumb
        items={[
          ...
          { name: "SIRS Reserve Studies", href: "/insurance/guides/sirs-structural-integrity-reserve-studies/" },
        ]}
      />
