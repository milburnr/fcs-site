...
const breadcrumbItems = [
  ...
  { name: "Tampa Residential Restoration After Hurricane Damage", href: "/insurance/guides/tampa-residential-restoration-after-hurricane-damage/" },
];
...
export default function Page() {
  return (
    <>
      ...
      {/* Final CTA */}
            <GuideCTA silo="insurance" heading="Restore Your Tampa Home After Hurricane Damage" />
    </>
  );
}
