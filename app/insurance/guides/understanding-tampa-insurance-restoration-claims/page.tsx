...
const breadcrumbItems = [
  ...
  { name: "Understanding Tampa Insurance Restoration Claims", href: "/insurance/guides/understanding-tampa-insurance-restoration-claims/" },
];
...
export default function Page() {
  return (
    <>
      ...
      {/* Final CTA */}
            <GuideCTA silo="insurance" heading="Expert Insurance Claim Support" />
    </>
  );
}
