...
export const metadata: Metadata = {
  alternates: { canonical: 'https://floridaconstructionspecialists.com/insurance/guides/tampa-insurance-restoration-for-hurricane-damage/' },
  title: "Tampa Hurricane Insurance Restoration | Commercial",
  description: "Discover hurricane insurance restoration commercial with Florida Construction Specialists. Licensed CBC, 40+ years of expertise.",
  openGraph: {
    title: "Tampa Hurricane Insurance Restoration | Commercial",
    description: "Discover hurricane insurance restoration commercial with Florida Construction Specialists. Licensed CBC, 40+ years of expertise.",
    url: "https://floridaconstructionspecialists.com/insurance/guides/tampa-insurance-restoration-for-hurricane-damage/",
    type: "website",
...
const breadcrumbItems = [
  ...
  { name: "Tampa Insurance Restoration for Hurricane Damage", href: "/insurance/guides/tampa-insurance-restoration-for-hurricane-damage/" },
];
...
export default function Page() {
  return (
    <>
      ...
      {/* Final CTA */}
            <GuideCTA silo="insurance" heading="Tampa Bay Insurance Restoration Specialists" />
    </>
  );
}
