...
export const metadata: Metadata = {
  ...
  description: "Learn how Florida's building codes create hurricane-resistant commercial structures. Expert guidance on wind-resistant design and impact glazing.",
  openGraph: {
...
const breadcrumbItems = [
  ...
  { name: "Building Hurricane Safe Structures Florida", href: "/insurance/guides/building-hurricane-safe-structures-florida/" },
];

const internalLinks = [
  { href: "/insurance/", label: "Disaster Recovery Services" },
  { href: "/disaster-recovery/", label: "Hurricane Damage Restoration" },
  { href: "/insurance/guides/reinforced-construction-services-in-tampa-for-disaster-prevention/", label: "Reinforced Construction" },
...
export default function Page() {
  return (
    <>
      ...
      {/* CTA */}
            <GuideCTA silo="insurance" heading="Build for Florida's Worst Weather" />
    </>
  );
}
