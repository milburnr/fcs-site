...
const breadcrumbItems = [
  ...
  { name: "Tampa's Insurance Restoration for Commercial Interiors", href: "/insurance/guides/tampas-insurance-restoration-for-commercial-interiors/" },
];
...
export default function Page() {
  return (
    <>
      ...
      {/* Final CTA */}
            <GuideCTA silo="insurance" heading="Expert Commercial Interior Restoration" />
    </>
  );
}
