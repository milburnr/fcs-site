...
const breadcrumbItems = [
  ...
  { name: "Impact of Climate Change on Tampa Insurance Restoration", href: "/insurance/guides/impact-of-climate-change-on-tampa-insurance-restoration/" },
];
...
const internalLinks = [
  ...
  { href: "/insurance/guides/tampas-building-codes-for-insurance-restoration/", label: "Building Codes and Restoration" },
...
export default function Page() {
  return (
    <>
      ...
      {/* Final CTA */}
            <GuideCTA silo="insurance" heading="Prepare Your Property for Climate Challenges" />
    </>
  );
}
