...
export const metadata: Metadata = {
  ...
  title: "Historic Restoration St. Pete | Old Northeast",
  description: "Historic restoration in St. Petersburg by Florida Construction Specialists. Old Northeast estates Historic Kenwood bungalows.",
  openGraph: {
    title: "Historic Restoration St. Pete | Old Northeast",
    description: "Historic restoration in St. Petersburg by Florida Construction Specialists. Old Northeast estates Historic Kenwood bungalows.",
    url: "https://floridaconstructionspecialists.com/historic-restoration-st-petersburg/",
    type: "website",
...
export default function HistoricRestorationStPetersburgPage() {
  return (
    <>
      ...
      {/* Internal Links */}
      <RelatedServiceLocations currentCity="St. Petersburg" currentService="historic-restoration" currentServiceName="Historic Restoration" />
    ...
    <RelatedArticles pageSlug="historic-restoration-st-petersburg" />
    </>
  );
}
