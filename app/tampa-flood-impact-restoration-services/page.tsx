...
export const metadata: Metadata = {
  alternates: { canonical: 'https://floridaconstructionspecialists.com/tampa-flood-impact-restoration-services/' },
  title: "Tampa Flood Impact Restoration Services",
  description: "Recover from disaster with Tampa Flood Impact Restoration Services! Our expert team specializes in flood damage restoration, water damage cleanup, and more.",
};

const breadcrumbItems = [
  { name: "Home", href: "/" },
  { name: "Tampa Flood Impact Restoration Services", href: "/tampa-flood-impact-restoration-services/" },
];
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="container-custom text-center text-white relative z-10">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 font-heading">
            Tampa Flood Impact Restoration Services
          </h1>
          <p className="text-xl max-w-3xl mx-auto text-gray-200">
            Recover from disaster with Tampa Flood Impact Restoration Services! Our expert team specializes in flood damage restoration, water damage cleanup, and
          </p>
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto prose prose-lg">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Restoring Properties After a Devastating Flood Importance of Flood Damage Restoration
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Restoring Your Property to Its Former Glory Water Damage Repair
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Addressing Flood Damage in Tampa Specialized Property Restoration Services
              </h2>
              <p className="text-gray-600 mb-6">
