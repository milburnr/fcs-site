...
export const metadata: Metadata = {
  title: "Emergency Glass Replacement in Tampa Post-Disaster - Florida Construction Specialists",
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto prose prose-lg">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Benefits of Rapid Glass Replacement Services for Tampa Properties Damaged in Disasters
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Emergency Glass Replacement to Restore Damaged Properties in Tampa
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Importance of PostDisaster Glass Replacement for Residents and Store Owners
              </h2>
              <p className="text-gray-600 mb-6">
