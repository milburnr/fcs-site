...
export const metadata: Metadata = {
  title: "Luxury Commercial Construction in Tampa - Florida Construction Specialists",
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto prose prose-lg">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Advantages of HighQuality Materials in Luxury Commercial Construction in Tampa
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Enhancing the Aesthetic Appeal of Commercial Properties with Upscale Techniques
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Key Features in HighEnd Architectural Design for Luxury Commercial Buildings
              </h2>
              <p className="text-gray-600 mb-6">
