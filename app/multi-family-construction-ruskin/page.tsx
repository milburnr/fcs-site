...
export default function MultiFamilyConstructionRuskinPage() {
  return (
    <>
      ...
      {/* Internal Links */}
      <RelatedServiceLocations currentCity="Ruskin" currentService="multi-family-construction" currentServiceName="Multi-Family Construction" />
    ...
    <RelatedArticles pageSlug="multi-family-construction-ruskin" />
    </>
  );
}
