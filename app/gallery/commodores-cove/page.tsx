...
const project = GALLERY_PROJECTS.find((p) => p.slug === "commodores-cove")!;
const slides = getProjectImages(project);

export const metadata: Metadata = {
  alternates: { canonical: "https://floridaconstructionspecialists.com/gallery/commodores-cove/" },
  ...
  openGraph: {
    ...
    url: "https://floridaconstructionspecialists.com/gallery/commodores-cove/",
    type: "website",
