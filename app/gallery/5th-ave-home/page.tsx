...
const project = GALLERY_PROJECTS.find((p) => p.slug === "5th-ave-home")!;
const slides = getProjectImages(project);

export const metadata: Metadata = {
  alternates: { canonical: "https://floridaconstructionspecialists.com/gallery/5th-ave-home/" },
  ...
  openGraph: {
    ...
    url: "https://floridaconstructionspecialists.com/gallery/5th-ave-home/",
    type: "website",
