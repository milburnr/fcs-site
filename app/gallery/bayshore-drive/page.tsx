...
const project = GALLERY_PROJECTS.find((p) => p.slug === "bayshore-drive")!;
const slides = getProjectImages(project);

export const metadata: Metadata = {
  alternates: { canonical: "https://floridaconstructionspecialists.com/gallery/bayshore-drive/" },
  ...
  openGraph: {
    ...
    url: "https://floridaconstructionspecialists.com/gallery/bayshore-drive/",
    type: "website",
