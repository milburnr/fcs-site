...
const project = GALLERY_PROJECTS.find((p) => p.slug === "mvp-orthodontics")!;
const slides = getProjectImages(project);

export const metadata: Metadata = {
  alternates: { canonical: "https://floridaconstructionspecialists.com/gallery/mvp-orthodontics/" },
  ...
  openGraph: {
    ...
    url: "https://floridaconstructionspecialists.com/gallery/mvp-orthodontics/",
    type: "website",
