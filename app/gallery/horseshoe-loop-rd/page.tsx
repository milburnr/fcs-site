...
const project = GALLERY_PROJECTS.find((p) => p.slug === "horseshoe-loop-rd")!;
const slides = getProjectImages(project);

export const metadata: Metadata = {
  alternates: { canonical: "https://floridaconstructionspecialists.com/gallery/horseshoe-loop-rd/" },
  ...
  openGraph: {
    ...
    url: "https://floridaconstructionspecialists.com/gallery/horseshoe-loop-rd/",
    type: "website",
