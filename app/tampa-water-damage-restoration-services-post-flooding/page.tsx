...
export const metadata: Metadata = {
  title: "Tampa water damage restoration Services Post-Flooding - Florida Construction Specialists",
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto prose prose-lg">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Why hire water damage restoration experts after a flood
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                How can flood cleanup services aid in postflood recovery
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Benefits of professional water extraction services
              </h2>
              <p className="text-gray-600 mb-6">
