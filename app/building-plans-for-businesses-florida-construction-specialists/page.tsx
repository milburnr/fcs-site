...
export const metadata: Metadata = {
  title: "Building Plans for Businesses: Florida Construction Specialists - Florida Construction Specialists",
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto prose prose-lg">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Why Choose Florida Construction Specialists as Your Top Commercial Contractor in Tampa
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Tailoring Building Plans to Meet Your Business Unique Commercial Construction Needs in Florida
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                The Importance of Building Design for Successful Commercial Construction Projects
              </h2>
              <p className="text-gray-600 mb-6">
