...
export const metadata: Metadata = {
  ...
  description: "Post-disaster Interior Restoration in Tampa: design-build, pre-construction, and project management. Licensed and insured CBC. Request a free estimate today.",
};
