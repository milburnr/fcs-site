  ...
  return (
    <>
      <ServiceSchema
        ...
        minPrice="100000"
      serviceCategories={["Office Buildouts","Space Reconfiguration","ADA Compliance","Common Area Upgrades"]}
      />
      <FAQSchema faqs={faqs} />
      ...
      <section className="py-16 bg-gray-50">
        <div className="container-custom">
          <InternalLinks title="Related Resources" links={[{ label: "Commercial Construction", href: "/commercial/" }, { label: "Plan Your Tenant Improvement", href: "/contact/" }]} />
        </div>
      </section>
