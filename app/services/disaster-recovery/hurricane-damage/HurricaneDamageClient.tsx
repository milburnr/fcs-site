...
const faqs = [
  ...
  },
  {
    ...
    answer: "We mobilize before hurricanes make landfall and begin response as soon as roads are passable. Pre-registered clients receive priority response. Our emergency teams typically arrive within 24-48 hours of storm passage to begin assessment, tarping, and board-up services. We maintain crews and equipment specifically for catastrophe response.",
  },
  {
...
const damageTypes = [
  ...
  },
  {
    ...
    description: "24/7 emergency response to secure your property and prevent additional damage from weather and intrusion.",
  },
];
...
export default function HurricaneDamageClient() {
  return (
    <>
      <LocalBusinessSchema service="Hurricane Damage Restoration" />
      <ServiceSchema
        serviceName="Hurricane Damage Restoration Services"
        serviceDescription="Professional hurricane damage restoration for Tampa Bay properties. Emergency storm response, structural repairs, water damage mitigation, and expert insurance claim support with 43+ years experience."
        minPrice="10000"
      />
      <FAQSchema faqs={faqs} />
          ...
          <div className="max-w-4xl">
            <FadeIn>
              <div className="inline-flex items-center gap-2 bg-red-500/20 border border-red-500/50 px-4 py-2 rounded-full mb-6">
                ...
                <span className="text-red-300 font-semibold">Emergency Response Available</span>
              </div>
            </FadeIn>
