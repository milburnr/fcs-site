...
export const metadata: Metadata = {
  ...
  title: "Luxury Kitchen Remodeling Tampa | High-End Renovations",
  description: "Licensed CBC with 40+ years delivering luxury kitchen remodels across Tampa Bay. Custom design, premium finishes, and hands-on project management.",
  openGraph: {
