...
export const metadata: Metadata = {
  ...
  description: "Luxury home builder Tampa Bay: waterfront construction, hurricane-resistant design. Custom residences, Davis Islands, South Tampa. Free consultation.",
};
