...
export const metadata: Metadata = {
  ...
  description: "Waterproofing Contractor in Ruskin: full-service general contractor for commercial and residential. 40+ years, licensed CBC. Call (813) 420-7561 for a quote.",
};
