...
export default function HistoricRestorationLakelandPage() {
  return (
    <>
      ...
      {/* Internal Links */}
      <RelatedServiceLocations currentCity="Lakeland" currentService="historic-restoration" currentServiceName="Historic Restoration" />
    ...
    <RelatedArticles pageSlug="historic-restoration-lakeland" />
    </>
  );
}
