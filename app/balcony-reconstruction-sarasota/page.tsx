...
export default function BalconyReconstructionSarasotaPage() {
  return (
    <>
      ...
      {/* Internal Links */}
      <RelatedServiceLocations currentCity="Sarasota" currentService="balcony-reconstruction" currentServiceName="Balcony Reconstruction" />
    ...
    <RelatedArticles pageSlug="balcony-reconstruction-sarasota" />
    </>
  );
}
