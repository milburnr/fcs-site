...
export const metadata: Metadata = {
  ...
  description: "Discover design-build benefits for commercial with Florida Construction Specialists. Licensed CGC, 40+ years of expertise. Call (813) 420-7561 for a quote.",
};
...
const breadcrumbItems = [
  ...
  { name: "Benefits of Design-Build Construction", href: "/commercial/guides/benefits-of-design-build-construction-for-commercial-project/" },
];

const internalLinks = [
  { href: "/services/commercial/design-build/", label: "Our Design-Build Services" },
  { href: "/commercial/guides/commercial-construction-stages-in-florida/", label: "Construction Stages Guide" },
  { href: "/commercial/guides/avoid-commercial-construction-delays-in-florida/", label: "Avoiding Project Delays" },
