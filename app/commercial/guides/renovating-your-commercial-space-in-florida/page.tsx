...
const breadcrumbItems = [
  ...
  { name: "Renovating Your Commercial Space in Florida", href: "/commercial/guides/renovating-your-commercial-space-in-florida/" },
];
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Ready to Plan Your Renovation Timeline?" />
    </>
  );
}
