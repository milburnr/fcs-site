...
const breadcrumbItems = [
  ...
  { name: "Sustainable Construction Trends in Florida", href: "/commercial/guides/sustainable-construction-trends-in-florida/" },
];
...
export default function Page() {
  return (
    <>
      ...
      <ArticleSchema
        headline="Sustainable Construction Trends in Florida"
        description="Explore the latest sustainable construction trends shaping Florida"
        datePublished="2024-01-01"
        slug="/commercial/guides/sustainable-construction-trends-in-florida/"
      />
      <FAQSchema faqs={faqs} />
      {/* Hero */}
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Ready to Embrace Sustainable Construction?" />
    </>
  );
}
