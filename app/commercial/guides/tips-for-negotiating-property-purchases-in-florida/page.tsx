...
const breadcrumbItems = [
  ...
  { name: "Tips for Negotiating Property Purchases in Florida", href: "/commercial/guides/tips-for-negotiating-property-purchases-in-florida/" },
];
...
const internalLinks = [
  { href: "/commercial/guides/tampa-commercial-real-estate-development/", label: "Real Estate Development" },
  { href: "/commercial/guides/investing-in-commercial-real-estate-construction/", label: "Investment Construction" },
  { href: "/commercial/guides/enhancing-commercial-property-value/", label: "Property Value Enhancement" },
...
export default function Page() {
  return (
    <>
      ...
      {/* Final CTA */}
            <GuideCTA silo="commercial" heading="Make Smarter Property Purchases" />
    </>
  );
}
