...
const breadcrumbItems = [
  ...
  { name: "The Role of a Construction Manager", href: "/commercial/guides/the-role-of-a-construction-manager/" },
];
...
export default function Page() {
  return (
    <>
      ...
      <ArticleSchema
        headline="Construction Manager Role Tampa | Commercial"
        ...
        slug="/commercial/guides/the-role-of-a-construction-manager/"
      />
      <FAQSchema faqs={faqs} />
      {/* Hero */}
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Ready to Partner with a Construction Manager?" />
    </>
  );
}
