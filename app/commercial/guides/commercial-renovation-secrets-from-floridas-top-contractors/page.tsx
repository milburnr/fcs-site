...
const breadcrumbItems = [
  ...
  { name: "Commercial Renovation Secrets", href: "/commercial/guides/commercial-renovation-secrets-from-floridas-top-contractors/" },
];
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Plan Your Renovation with Experts" />
    </>
  );
}
