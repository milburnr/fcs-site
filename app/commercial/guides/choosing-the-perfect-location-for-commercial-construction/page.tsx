...
const breadcrumbItems = [
  ...
  { name: "Choosing the Perfect Location for Commercial Construction", href: "/commercial/guides/choosing-the-perfect-location-for-commercial-construction/" },
];
...
export default function Page() {
  return (
    <>
      ...
      <ArticleSchema
        headline="Choosing the Perfect Location for Commercial Construction"
        ...
        slug="/commercial/guides/choosing-the-perfect-location-for-commercial-construction/"
      />
      <FAQSchema faqs={faqs} />
      {/* Hero */}
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Need Help Evaluating Commercial Sites?" />
    </>
  );
}
