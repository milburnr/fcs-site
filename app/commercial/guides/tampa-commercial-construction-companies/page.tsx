...
export const metadata: Metadata = {
  alternates: { canonical: 'https://floridaconstructionspecialists.com/commercial/guides/tampa-commercial-construction-companies/' },
  ...
  openGraph: {
    title: "Tampa Commercial Construction Companies | Guide",
    description: "Find the right commercial construction company for your project. Expert insights from Florida Construction Specialists. Request a free estimate today.",
    url: "https://floridaconstructionspecialists.com/commercial/guides/tampa-commercial-construction-companies/",
    type: "website",
...
const breadcrumbItems = [
  ...
  { name: "Tampa Commercial Construction Companies", href: "/commercial/guides/tampa-commercial-construction-companies/" },
];

const internalLinks = [
  { href: "/commercial/", label: "Our Commercial Services" },
  ...
  { href: "/commercial/guides/subcontractors-in-florida-commercial-construction/", label: "Working with Subcontractors" },
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Ready to Discuss Your Project?" />
    </>
  );
}
