...
const breadcrumbItems = [
  ...
  { name: "Tampa Commercial Construction Trends Updates 2024", href: "/commercial/guides/tampa-commercial-construction-trends-updates-2024/" },
];
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Navigate Tampa's Construction Market With Confidence" />
    </>
  );
}
