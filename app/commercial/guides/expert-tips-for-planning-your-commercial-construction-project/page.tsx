...
const breadcrumbItems = [
  ...
  { name: "Expert Tips for Planning Your Commercial Construction Project", href: "/commercial/guides/expert-tips-for-planning-your-commercial-construction-project/" },
];
...
const internalLinks = [
  ...
  { href: "/commercial/guides/construction-project-management-and-scheduling/", label: "Project Management Tips" },
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Ready to Plan Your Commercial Project?" />
    </>
  );
}
