...
const breadcrumbItems = [
  ...
  { name: "Revitalize Your Older Building", href: "/commercial/guides/revitalize-your-older-building-renovation-and-reconstruction/" },
];

const internalLinks = [
  { href: "/commercial/", label: "Commercial Construction Services" },
  { href: "/services/commercial/design-build/", label: "Design-Build Construction" },
  { href: "/commercial/guides/commercial-buildings-facade-renovations/", label: "Facade Renovations" },
  { href: "/commercial/guides/renovating-vs-new-construction-florida/", label: "Renovation vs. New Construction" },
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Ready to Transform Your Older Building?" />
    </>
  );
}
