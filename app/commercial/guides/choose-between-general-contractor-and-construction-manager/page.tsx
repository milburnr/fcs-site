...
const breadcrumbItems = [
  ...
  { name: "General Contractor vs Construction Manager", href: "/commercial/guides/choose-between-general-contractor-and-construction-manager/" },
];

const internalLinks = [
  { href: "/commercial/", label: "Commercial Construction Services" },
  { href: "/services/commercial/design-build/", label: "Design-Build Construction" },
  { href: "/commercial/guides/the-role-of-a-construction-manager/", label: "Construction Manager Duties" },
...
export default function Page() {
  return (
    <>
      ...
      <ArticleSchema
        headline="GC vs Construction Manager Tampa | Which to Choose"
        description="Discover gc vs construction manager which to choose with Florida Construction Specialists. Licensed CBC, 40+ years of expertise. Request a free estimate today."
        datePublished="2024-01-01"
        slug="/commercial/guides/choose-between-general-contractor-and-construction-manager/"
      />
      <FAQSchema faqs={faqs} />
      {/* Hero */}
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Need Help Choosing the Right Approach?" />
    </>
  );
}
