...
const breadcrumbItems = [
  ...
  { name: "Safety First in Florida Commercial Construction Projects", href: "/commercial/guides/safety-first-in-florida-commercial-construction-projects/" },
];
...
const internalLinks = [
  ...
  { href: "/commercial/guides/tampa-commercial-construction-permits/", label: "Construction Permits" },
...
export default function Page() {
  return (
    <>
      ...
      {/* Final CTA */}
            <GuideCTA silo="commercial" heading="Safety-First Commercial Construction" />
    </>
  );
}
