...
const breadcrumbItems = [
  ...
  { name: "Renovating vs. New Construction Florida", href: "/commercial/guides/renovating-vs-new-construction-florida/" },
];
  ...
  return (
    <>
      ...
      <ArticleSchema
        ...
        slug="/commercial/guides/renovating-vs-new-construction-florida/"
      />
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Need Help Deciding Between Renovation and New Construction?" />
    </>
  );
}
