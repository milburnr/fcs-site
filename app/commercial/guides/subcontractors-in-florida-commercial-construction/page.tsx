...
const breadcrumbItems = [
  ...
  { name: "Subcontractors in Florida Commercial Construction", href: "/commercial/guides/subcontractors-in-florida-commercial-construction/" },
];

const internalLinks = [
  { href: "/commercial/", label: "Commercial Construction Services" },
  { href: "/commercial/guides/tampa-commercial-construction-companies/", label: "Choosing Contractors" },
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Partner with Tampa's Best Trade Network" />
    </>
  );
}
