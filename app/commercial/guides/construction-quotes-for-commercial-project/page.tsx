...
const breadcrumbItems = [
  ...
  { name: "Construction Quotes for Commercial Project", href: "/commercial/guides/construction-quotes-for-commercial-project/" },
];

const internalLinks = [
  { href: "/commercial/guides/financial-planning-for-commercial-construction/", label: "Financial Planning Guide" },
  { href: "/commercial/guides/expert-tips-for-planning-your-commercial-construction-project/", label: "Planning Tips" },
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Ready to Get a Professional Construction Quote?" />
    </>
  );
}
