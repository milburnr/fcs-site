...
const breadcrumbItems = [
  ...
  { name: "Tampa Commercial Construction Bidding Process", href: "/commercial/guides/tampa-commercial-construction-bidding-process/" },
];
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Ready to Start Your Project?" />
    </>
  );
}
