...
const breadcrumbItems = [
  ...
  { name: "Key Signs Your Commercial Remodel Needs", href: "/commercial/guides/key-signs-your-commercial-remodel-needs/" },
];
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Not Sure If Your Building Needs Renovation?" />
    </>
  );
}
