...
const breadcrumbItems = [
  ...
  { name: "Condo Balcony Inspection Requirements", href: "/commercial/guides/condo-balcony-inspection-requirements/" },
];
  ...
  return (
    <>
      ...
      <ArticleSchema
        ...
        slug="/commercial/guides/condo-balcony-inspection-requirements/"
      />
      <FAQSchema faqs={faqs} />
      ...
      <Breadcrumb
        items={[
          ...
          { name: "Balcony Inspection Requirements", href: "/commercial/guides/condo-balcony-inspection-requirements/" },
        ]}
      />
