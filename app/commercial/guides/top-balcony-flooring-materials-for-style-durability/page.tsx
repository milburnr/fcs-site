...
const breadcrumbItems = [
  ...
  { name: "Top Balcony Flooring Materials", href: "/commercial/guides/top-balcony-flooring-materials-for-style-durability/" },
];
...
const internalLinks = [
  ...
  { href: "/commercial/guides/balcony-restoration-services/", label: "Balcony Restoration" },
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Upgrade Your Balcony Flooring Today" />
    </>
  );
}
