...
const breadcrumbItems = [
  ...
  { name: "Crafting the Ideal Commercial Blueprint in Tampa", href: "/commercial/guides/crafting-the-ideal-commercial-blueprint-in-tampa-florida/" },
];
...
const internalLinks = [
  ...
  { href: "/commercial/guides/building-the-perfect-construction-blueprint/", label: "Construction Blueprint Guide" },
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Ready to Start Your Commercial Blueprint?" />
    </>
  );
}
