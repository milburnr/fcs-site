...
const breadcrumbItems = [
  ...
  { name: "Preserving Tampa's Cultural Heritage through Restoration", href: "/commercial/guides/preserving-tampas-cultural-heritage-through-restoration/" },
];
...
export default function Page() {
  return (
    <>
      ...
      <ArticleSchema
        headline="Preserving Tampa"
        description="Protecting Tampa"
        datePublished="2024-01-01"
        slug="/commercial/guides/preserving-tampas-cultural-heritage-through-restoration/"
      />
      <FAQSchema faqs={faqs} />
      {/* Hero */}
