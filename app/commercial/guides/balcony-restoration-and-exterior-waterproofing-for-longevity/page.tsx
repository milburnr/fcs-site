...
const breadcrumbItems = [
  ...
  { name: "Balcony Restoration & Waterproofing for Longevity", href: "/commercial/guides/balcony-restoration-and-exterior-waterproofing-for-longevity/" },
];
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Plan for Long-Term Performance" />
    </>
  );
}
