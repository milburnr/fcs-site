...
const breadcrumbItems = [
  ...
  { name: "Decoding Commercial Construction Costs", href: "/commercial/guides/decoding-commercial-construction-costs/" },
];
...
const internalLinks = [
  ...
  { href: "/commercial/guides/unveiling-floridas-top-hidden-commercial-construction-costs/", label: "Hidden Costs Guide" },
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Ready to Understand Your Project Costs?" />
    </>
  );
}
