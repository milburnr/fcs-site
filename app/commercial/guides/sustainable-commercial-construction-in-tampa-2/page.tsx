...
const breadcrumbItems = [
  ...
  { name: "Sustainable Commercial Construction in Tampa", href: "/commercial/guides/sustainable-commercial-construction-in-tampa-2/" },
];
...
export default function Page() {
  return (
    <>
      ...
      <ArticleSchema
        headline="Sustainable Commercial Construction in Tampa"
        ...
        slug="/commercial/guides/sustainable-commercial-construction-in-tampa-2/"
      />
      <FAQSchema faqs={faqs} />
      {/* Hero */}
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Ready to Build a Sustainable Future?" />
    </>
  );
}
