...
const breadcrumbItems = [
  ...
  { name: "Tampa Commercial Construction Planning Services", href: "/commercial/guides/tampa-commercial-construction-planning-services/" },
];
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Let's Plan Your Project Right" />
    </>
  );
}
