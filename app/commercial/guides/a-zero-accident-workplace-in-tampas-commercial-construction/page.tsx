...
const breadcrumbItems = [
  ...
  { name: "Zero Accident Workplace in Tampa's Commercial Construction", href: "/commercial/guides/a-zero-accident-workplace-in-tampas-commercial-construction/" },
];
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Choose a Contractor Who Values Safety" />
    </>
  );
}
