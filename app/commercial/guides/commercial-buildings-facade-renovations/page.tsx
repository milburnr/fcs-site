...
const breadcrumbItems = [
  ...
  { name: "Commercial Buildings Facade Renovations", href: "/commercial/guides/commercial-buildings-facade-renovations/" },
];
...
const internalLinks = [
  ...
  { href: "/commercial/guides/key-signs-your-commercial-remodel-needs/", label: "Signs You Need Renovation" },
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Ready to Transform Your Building's Facade?" />
    </>
  );
}
