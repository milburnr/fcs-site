...
const breadcrumbItems = [
  ...
  { name: "Ensuring Construction Site Safety a Top Priority", href: "/commercial/guides/ensuring-construction-site-safety-a-top-priority/" },
];
...
export default function Page() {
  return (
    <>
      ...
      <ArticleSchema
        headline="Construction Site Safety Tampa | Top Priority"
        description="Ensuring construction site safety is Florida Construction Specialists"
        datePublished="2024-01-01"
        slug="/commercial/guides/ensuring-construction-site-safety-a-top-priority/"
      />
      <FAQSchema faqs={faqs} />
      ...
      {/* Final CTA */}
            <GuideCTA silo="commercial" heading="Safety-First Construction in Tampa Bay" />
    </>
  );
}
