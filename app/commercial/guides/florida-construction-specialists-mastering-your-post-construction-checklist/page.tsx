...
const breadcrumbItems = [
  ...
  { name: "Mastering Your Post-Construction Checklist", href: "/commercial/guides/florida-construction-specialists-mastering-your-post-construction-checklist/" },
];

const internalLinks = [
  { href: "/commercial/", label: "Commercial Construction Services" },
  { href: "/commercial/guides/tips-for-post-construction-in-florida-commercial-sector/", label: "Post-Construction Tips" },
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Need Help with Project Closeout?" />
    </>
  );
}
