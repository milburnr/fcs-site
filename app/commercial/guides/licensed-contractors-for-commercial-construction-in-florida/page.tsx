...
const breadcrumbItems = [
  ...
  { name: "Licensed Contractors for Commercial Construction in Florida", href: "/commercial/guides/licensed-contractors-for-commercial-construction-in-florida/" },
];
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Work With Licensed Professionals" />
    </>
  );
}
