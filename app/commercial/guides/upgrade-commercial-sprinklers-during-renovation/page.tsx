...
const breadcrumbItems = [
  ...
  { name: "Upgrade Commercial Sprinklers During Renovation", href: "/commercial/guides/upgrade-commercial-sprinklers-during-renovation/" },
];
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Planning a Renovation? Include Fire Protection Assessment" />
    </>
  );
}
