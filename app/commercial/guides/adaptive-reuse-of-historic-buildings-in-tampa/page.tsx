...
const breadcrumbItems = [
  ...
  { name: "Adaptive Reuse of Historic Buildings in Tampa", href: "/commercial/guides/adaptive-reuse-of-historic-buildings-in-tampa/" },
];
...
export default function Page() {
  return (
    <>
      ...
      <ArticleSchema
        headline="Adaptive Reuse Historic Buildings Tampa | FCS"
        description="Transform Tampa"
        datePublished="2024-01-01"
        slug="/commercial/guides/adaptive-reuse-of-historic-buildings-in-tampa/"
      />
      <FAQSchema faqs={faqs} />
      {/* Hero */}
