...
export const metadata: Metadata = {
  ...
  description: "Discover financial planning commercial construction with Florida Construction Specialists. Licensed CBC, 40+ years of expertise.",
  openGraph: {
    title: "Financial Planning Commercial Construction Tampa",
    description: "Discover financial planning commercial construction with Florida Construction Specialists. Licensed CBC, 40+ years of expertise.",
    url: "https://floridaconstructionspecialists.com/commercial/guides/financial-planning-for-commercial-construction/",
    type: "website",
...
const breadcrumbItems = [
  ...
  { name: "Financial Planning for Commercial Construction", href: "/commercial/guides/financial-planning-for-commercial-construction/" },
];

const internalLinks = [
  { href: "/commercial/guides/construction-quotes-for-commercial-project/", label: "Construction Quotes Guide" },
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Ready to Plan Your Commercial Construction Budget?" />
    </>
  );
}
