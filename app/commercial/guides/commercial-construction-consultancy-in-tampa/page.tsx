...
const breadcrumbItems = [
  ...
  { name: "Commercial Construction Consultancy in Tampa", href: "/commercial/guides/commercial-construction-consultancy-in-tampa/" },
];

const internalLinks = [
  { href: "/commercial/", label: "Commercial Construction Services" },
  { href: "/commercial/guides/tampa-commercial-construction-planning-services/", label: "Planning Services" },
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Get Expert Guidance for Your Project" />
    </>
  );
}
