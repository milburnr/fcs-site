...
const breadcrumbItems = [
  ...
  { name: "Office Windows & Performance", href: "/commercial/guides/boosting-performance-in-florida-offices-windows/" },
];

const internalLinks = [
  { href: "/services/commercial/tenant-improvements/", label: "Tenant Improvements" },
  { href: "/commercial/guides/employee-communication-with-office-layout/", label: "Office Layout Design" },
  { href: "/commercial/guides/expert-insights-on-ways-t0-enhanced-office-building-security/", label: "Office Building Security" },
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Ready to Upgrade Your Office Windows?" />
    </>
  );
}
