...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Balcony Railing Designs Tampa | High-Rise Styles",
    description: "Premium balcony railing designs for Tampa Bay high-rise condominiums. Expert insights from Florida Construction Specialists. Request a free estimate today.",
    url: "https://floridaconstructionspecialists.com/commercial/guides/stylish-balcony-railing-designs-for-your-outdoor-space/",
    type: "website",
...
const breadcrumbItems = [
  ...
  { name: "Stylish Balcony Railing Designs", href: "/commercial/guides/stylish-balcony-railing-designs-for-your-outdoor-space/" },
];

const internalLinks = [
  { href: "/commercial/guides/balcony-restoration-services/", label: "Balcony Restoration Services" },
  { href: "/commercial/guides/expert-balcony-construction-guidelines-for-optimal-results/", label: "Balcony Construction Guidelines" },
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Upgrade Your Building's Balcony Railings" />
    </>
  );
}
