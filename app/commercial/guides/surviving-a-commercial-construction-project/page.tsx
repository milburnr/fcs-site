...
const breadcrumbItems = [
  ...
  { name: "Surviving a Commercial Construction Project", href: "/commercial/guides/surviving-a-commercial-construction-project/" },
];

const internalLinks = [
  { href: "/commercial/", label: "Commercial Construction Services" },
  { href: "/commercial/guides/expert-tips-for-planning-your-commercial-construction-project/", label: "Project Planning Tips" },
  { href: "/commercial/guides/avoid-commercial-construction-delays-in-florida/", label: "Avoiding Construction Delays" },
  { href: "/commercial/guides/construction-project-management-and-scheduling/", label: "Project Management Guide" },
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Ready for a Partner Who Makes Construction Manageable?" />
    </>
  );
}
