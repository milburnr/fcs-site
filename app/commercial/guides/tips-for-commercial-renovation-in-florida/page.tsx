...
const breadcrumbItems = [
  ...
  { name: "Tips for Commercial Renovation in Florida", href: "/commercial/guides/tips-for-commercial-renovation-in-florida/" },
];
  ...
  return (
    <>
      ...
      <ArticleSchema
        ...
        slug="/commercial/guides/tips-for-commercial-renovation-in-florida/"
      />
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Partner with Florida's Commercial Renovation Experts" />
    </>
  );
}
