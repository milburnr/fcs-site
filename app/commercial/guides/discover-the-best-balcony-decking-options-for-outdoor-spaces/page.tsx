...
const breadcrumbItems = [
  ...
  { name: "Best Balcony Decking Options", href: "/commercial/guides/discover-the-best-balcony-decking-options-for-outdoor-spaces/" },
];
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Transform Your Balconies with Premium Decking" />
    </>
  );
}
