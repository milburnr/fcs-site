...
const breadcrumbItems = [
  ...
  { name: "Zero Net Energy Boosting Commercial Construction", href: "/commercial/guides/zero-net-energy-boosting-commercial-construction/" },
];
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Ready to Explore Zero Net Energy for Your Project?" />
    </>
  );
}
