...
export const metadata: Metadata = {
  ...
  description: "Discover restaurant design & construction with Florida Construction Specialists. Licensed CGC, 40+ years of expertise. Schedule your consultation now.",
};
...
const breadcrumbItems = [
  ...
  { name: "Restaurant Design & Construction", href: "/commercial/guides/successful-restaurant-design-with-florida-construction-specialists/" },
];
...
const internalLinks = [
  ...
  { href: "/commercial/", label: "Retail Space Design" },
