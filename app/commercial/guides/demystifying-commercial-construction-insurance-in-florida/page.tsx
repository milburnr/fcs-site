...
const breadcrumbItems = [
  ...
  { name: "Demystifying Commercial Construction Insurance in Florida", href: "/commercial/guides/demystifying-commercial-construction-insurance-in-florida/" },
];
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Partner with a Properly Insured Contractor" />
    </>
  );
}
