...
const breadcrumbItems = [
  ...
  { name: "Tampa Commercial Construction Permits", href: "/commercial/guides/tampa-commercial-construction-permits/" },
];
...
export default function Page() {
  return (
    <>
      ...
      {/* Final CTA */}
            <GuideCTA silo="commercial" heading="Streamlined Commercial Permitting" />
    </>
  );
}
