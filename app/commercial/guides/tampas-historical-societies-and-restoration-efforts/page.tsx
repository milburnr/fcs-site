...
const breadcrumbItems = [
  ...
  { name: "Tampa's Historical Societies and Restoration Efforts", href: "/commercial/guides/tampas-historical-societies-and-restoration-efforts/" },
];
...
export default function Page() {
  return (
    <>
      ...
      <ArticleSchema
        headline="Tampa"
        description="Learn about Tampa"
        datePublished="2024-01-01"
        slug="/commercial/guides/tampas-historical-societies-and-restoration-efforts/"
      />
      <FAQSchema faqs={faqs} />
      {/* Hero */}
