...
const breadcrumbItems = [
  ...
  { name: "Customized Outdoor Sports Facilities in Tampa Homes", href: "/commercial/guides/customized-outdoor-sports-facilities-in-tampa-homes/" },
];
...
export default function Page() {
  return (
    <>
      ...
      <ArticleSchema
        headline="Outdoor Sports Facilities Tampa Homes | Courts"
        description="Discover outdoor sports facilities homes courts with Florida Construction Specialists. Licensed CBC, 40+ years of expertise. Request a free estimate today."
        datePublished="2024-01-01"
        slug="/commercial/guides/customized-outdoor-sports-facilities-in-tampa-homes/"
      />
      <FAQSchema faqs={faqs} />
      {/* Hero */}
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Ready to Build Your Sports Facility?" />
    </>
  );
}
