...
const breadcrumbItems = [
  ...
  { name: "The Essential Role of Florida Construction Specialists", href: "/commercial/guides/the-essential-role-of-florida-construction-specialists/" },
];
...
export default function Page() {
  return (
    <>
      ...
      {/* Final CTA */}
            <GuideCTA silo="commercial" heading="Building Tampa Bay's Future" />
    </>
  );
}
