...
const breadcrumbItems = [
  ...
  { name: "Efficient Site Planning for Commercial Construction", href: "/commercial/guides/efficient-site-planning-for-commercial-construction-in-florida/" },
];
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Plan Your Site Development" />
    </>
  );
}
