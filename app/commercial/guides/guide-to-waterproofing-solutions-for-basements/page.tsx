...
const breadcrumbItems = [
  ...
  { name: "Guide to Waterproofing Solutions for Basements", href: "/commercial/guides/guide-to-waterproofing-solutions-for-basements/" },
];

const internalLinks = [
  { href: "/commercial/guides/ultimate-waterproofing-guide-foundations/", label: "Foundation Waterproofing Guide" },
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Stop Water Intrusion in Your Below-Grade Spaces" />
    </>
  );
}
