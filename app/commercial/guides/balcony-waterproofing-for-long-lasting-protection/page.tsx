...
const breadcrumbItems = [
  ...
  { name: "Balcony Waterproofing for Long Lasting Protection", href: "/commercial/guides/balcony-waterproofing-for-long-lasting-protection/" },
];
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Protect Your Balconies with Professional Waterproofing" />
    </>
  );
}
