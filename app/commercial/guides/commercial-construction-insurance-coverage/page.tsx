...
const breadcrumbItems = [
  ...
  { name: "Commercial Construction Insurance Coverage", href: "/commercial/guides/commercial-construction-insurance-coverage/" },
];
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Work With a Properly Insured Contractor" />
    </>
  );
}
