...
const breadcrumbItems = [
  ...
  { name: "Office Layout & Communication", href: "/commercial/guides/employee-communication-with-office-layout/" },
];

const internalLinks = [
  { href: "/services/commercial/tenant-improvements/", label: "Tenant Improvements" },
  { href: "/commercial/guides/boosting-performance-in-florida-offices-windows/", label: "Office Windows" },
  { href: "/commercial/guides/maximize-work-area-efficiency-for-commercial-space-solutions/", label: "Space Efficiency" },
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Ready to Transform Your Office?" />
    </>
  );
}
