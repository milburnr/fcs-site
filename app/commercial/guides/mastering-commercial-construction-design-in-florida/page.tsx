...
const breadcrumbItems = [
  ...
  { name: "Mastering Commercial Construction Design in Florida", href: "/commercial/guides/mastering-commercial-construction-design-in-florida/" },
];
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Ready to Design Your Commercial Project?" />
    </>
  );
}
