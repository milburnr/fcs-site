...
const breadcrumbItems = [
  ...
  { name: "Common Construction Mistakes to Avoid", href: "/commercial/guides/common-construction-mistakes-to-avoid-for-commercial-project/" },
];
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Protect Your Project Investment" />
    </>
  );
}
