...
const breadcrumbItems = [
  ...
  { name: "Top Causes of Construction Delays in Florida", href: "/commercial/guides/the-top-causes-of-construction-delays-in-florida/" },
];
...
export default function Page() {
  return (
    <>
      ...
      <ArticleSchema
        headline="Construction Delays Florida | Tampa Bay Causes"
        description="Discover construction delays florida causes with Florida Construction Specialists. Licensed CBC, 40+ years of expertise. Call (813) 420-7561 for a quote."
        datePublished="2024-01-01"
        slug="/commercial/guides/the-top-causes-of-construction-delays-in-florida/"
      />
      <FAQSchema faqs={faqs} />
      {/* Hero */}
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Minimize Delays on Your Project" />
    </>
  );
}
