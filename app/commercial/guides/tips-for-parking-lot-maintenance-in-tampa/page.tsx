...
const breadcrumbItems = [
  ...
  { name: "Tips for Parking Lot Maintenance in Tampa", href: "/commercial/guides/tips-for-parking-lot-maintenance-in-tampa/" },
];
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Protect Your Tampa Parking Lot Investment" />
</>
  );
}
