...
const breadcrumbItems = [
  ...
  { name: "Tampa Commercial Construction Market Analysis", href: "/commercial/guides/tampa-commercial-construction-market-analysis/" },
];
...
const internalLinks = [
  ...
  { href: "/commercial/guides/tampa-commercial-construction-companies/", label: "Top Contractors" },
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Ready to Build in Tampa Bay?" />
    </>
  );
}
