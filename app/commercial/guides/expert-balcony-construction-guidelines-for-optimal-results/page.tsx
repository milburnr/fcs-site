...
const breadcrumbItems = [
  ...
  { name: "Expert Balcony Construction Guidelines", href: "/commercial/guides/expert-balcony-construction-guidelines-for-optimal-results/" },
];
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Plan Your Balcony Construction Project" />
    </>
  );
}
