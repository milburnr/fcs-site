...
const breadcrumbItems = [
  ...
  { name: "Architectural Styles in Tampa's Historic Restoration", href: "/commercial/guides/architectural-styles-in-tampas-historic-restoration/" },
];
...
export default function Page() {
  return (
    <>
      ...
      <ArticleSchema
        headline="Architectural Styles in Tampa Historic Restoration"
        description="Expert guide to Tampa"
        datePublished="2024-01-01"
        slug="/commercial/guides/architectural-styles-in-tampas-historic-restoration/"
      />
      <FAQSchema faqs={faqs} />
      {/* Hero */}
