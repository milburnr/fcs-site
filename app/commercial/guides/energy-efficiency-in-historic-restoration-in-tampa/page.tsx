...
const breadcrumbItems = [
  ...
  { name: "Energy Efficiency in Historic Restoration in Tampa", href: "/commercial/guides/energy-efficiency-in-historic-restoration-in-tampa/" },
];
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Ready to Restore Your Historic Building?" />
    </>
  );
}
