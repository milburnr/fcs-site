...
const breadcrumbItems = [
  ...
  { name: "Value Engineering in Commercial Construction", href: "/commercial/guides/value-engineering-in-commercial-construction/" },
];

const internalLinks = [
  { href: "/commercial/guides/benefits-of-value-engineering-for-construction/", label: "VE Benefits Deep Dive" },
  { href: "/commercial/guides/decoding-value-engineering-florida-construction-expertise/", label: "Florida VE Expertise" },
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Ready to Maximize Your Project's Value?" />
    </>
  );
}
