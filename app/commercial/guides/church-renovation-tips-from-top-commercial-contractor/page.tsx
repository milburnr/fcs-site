...
const breadcrumbItems = [
  ...
  { name: "Church Renovation Tips", href: "/commercial/guides/church-renovation-tips-from-top-commercial-contractor/" },
];
  ...
  return (
    <>
      ...
      <ArticleSchema
        ...
        slug="/commercial/guides/church-renovation-tips-from-top-commercial-contractor/"
      />
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Ready to Transform Your Church Facilities?" />
    </>
  );
}
