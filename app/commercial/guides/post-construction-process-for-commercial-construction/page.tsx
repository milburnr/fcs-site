...
const breadcrumbItems = [
  ...
  { name: "Post Construction Process for Commercial Construction", href: "/commercial/guides/post-construction-process-for-commercial-construction/" },
];
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Ready to Start Your Commercial Construction Project?" />
    </>
  );
}
