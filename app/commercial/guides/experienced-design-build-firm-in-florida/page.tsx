...
const breadcrumbItems = [
  ...
  { name: "Experienced Design Build Firm in Florida", href: "/commercial/guides/experienced-design-build-firm-in-florida/" },
];
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Ready to Partner with Tampa Bay's Experienced Design-Build Team?" />
    </>
  );
}
