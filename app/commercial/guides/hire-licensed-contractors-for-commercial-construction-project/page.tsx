...
const breadcrumbItems = [
  ...
  { name: "Hire Licensed Contractors for Commercial Construction", href: "/commercial/guides/hire-licensed-contractors-for-commercial-construction-project/" },
];
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Work With a Licensed, Bonded, Insured Contractor" />
    </>
  );
}
