...
const breadcrumbItems = [
  ...
  { name: "Building Strong Communities Through Community Outreach", href: "/commercial/guides/building-strong-communities-through-community-outreach/" },
];
...
export default function Page() {
  return (
    <>
      ...
      <ArticleSchema
        headline="Building Strong Communities Through Community Outreach"
        description="Florida Construction Specialists"
        datePublished="2024-01-01"
        slug="/commercial/guides/building-strong-communities-through-community-outreach/"
      />
      <FAQSchema faqs={faqs} />
      {/* Hero */}
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Ready to Partner With Us?" />
    </>
  );
}
