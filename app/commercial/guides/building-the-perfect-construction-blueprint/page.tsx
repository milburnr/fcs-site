...
export const metadata: Metadata = {
  ...
  description: "Discover building the perfect construction blueprint with Florida Construction Specialists. Licensed CBC, 40+ years of expertise.",
  openGraph: {
    title: "Building the Perfect Construction Blueprint",
    description: "Discover building the perfect construction blueprint with Florida Construction Specialists. Licensed CBC, 40+ years of expertise.",
    url: "https://floridaconstructionspecialists.com/commercial/guides/building-the-perfect-construction-blueprint/",
    type: "website",
...
const breadcrumbItems = [
  ...
  { name: "Building the Perfect Construction Blueprint", href: "/commercial/guides/building-the-perfect-construction-blueprint/" },
];
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Ready for Blueprint Excellence?" />
    </>
  );
}
