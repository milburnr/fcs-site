...
export const metadata: Metadata = {
  ...
  description: "Discover building the perfect construction blueprint with Florida Construction Specialists. Licensed CBC, 40+ years of expertise. Request a free estimate today.",
};
