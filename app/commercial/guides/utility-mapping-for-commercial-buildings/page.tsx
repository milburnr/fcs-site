...
const breadcrumbItems = [
  ...
  { name: "Utility Mapping for Commercial Buildings", href: "/commercial/guides/utility-mapping-for-commercial-buildings/" },
];
...
export default function Page() {
  return (
    <>
      ...
      {/* Final CTA */}
            <GuideCTA silo="commercial" heading="Know What's Below Before You Dig" />
    </>
  );
}
