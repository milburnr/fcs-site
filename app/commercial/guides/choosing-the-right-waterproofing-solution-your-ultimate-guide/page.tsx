...
export const metadata: Metadata = {
  ...
  description: "Complete guide to selecting commercial waterproofing systems for Tampa Bay high-rises. From FCS, your licensed CBC in ${region}. Request a free estimate today.",
};
...
const breadcrumbItems = [
  ...
  { name: "Choosing the Right Waterproofing Solution", href: "/commercial/guides/choosing-the-right-waterproofing-solution-your-ultimate-guide/" },
];
...
const internalLinks = [
  ...
  { href: "/commercial/guides/discover-the-benefits-of-exterior-waterproofing/", label: "Benefits of Exterior Waterproofing" },
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Get Expert Guidance on Waterproofing Selection" />
    </>
  );
}
