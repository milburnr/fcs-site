...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Construction Project Management Stages | Tampa",
    description: "Discover construction project management stages with Florida Construction Specialists. Licensed CBC, 40+ years of expertise. Request a free estimate today.",
    url: "https://floridaconstructionspecialists.com/commercial/guides/the-stages-of-construction-project-management/",
    type: "website",
...
const breadcrumbItems = [
  ...
  { name: "Stages of Construction Project Management", href: "/commercial/guides/the-stages-of-construction-project-management/" },
];

const internalLinks = [
  { href: "/commercial/", label: "Commercial Construction Services" },
  { href: "/commercial/guides/the-role-of-a-construction-manager/", label: "Role of a Construction Manager" },
  { href: "/commercial/guides/the-essential-duties-of-a-construction-manager-in-florida/", label: "CM Duties in Florida" },
  { href: "/commercial/guides/build-a-successful-future-in-construction-management/", label: "Construction Management Success" },
...
export default function Page() {
  return (
    <>
      ...
      <ArticleSchema
        headline="Construction Project Management Stages | Tampa"
        description="Discover construction project management stages with Florida Construction Specialists. Licensed CBC, 40+ years of expertise. Request a free estimate today."
        datePublished="2024-01-01"
        slug="/commercial/guides/the-stages-of-construction-project-management/"
      />
      <FAQSchema faqs={faqs} />
      {/* Hero */}
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Ready for Professional Project Management?" />
    </>
  );
}
