...
const breadcrumbItems = [
  ...
  { name: "Commercial Construction Regulations in Tampa", href: "/commercial/guides/commercial-construction-regulations-in-tampa/" },
];
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Navigate Tampa Regulations with Confidence" />
    </>
  );
}
