...
const breadcrumbItems = [
  ...
  { name: "Revolutionizing Commercial Construction Florida", href: "/commercial/guides/revolutionizing-commercial-construction-florida/" },
];
...
const internalLinks = [
  ...
  { href: "/commercial/guides/sustainable-commercial-construction-in-tampa-2/", label: "Sustainable Construction" },
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Ready to Build with Florida's Innovative Construction Leader?" />
    </>
  );
}
