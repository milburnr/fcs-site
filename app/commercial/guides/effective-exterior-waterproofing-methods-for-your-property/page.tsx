...
const breadcrumbItems = [
  ...
  { name: "Effective Exterior Waterproofing Methods", href: "/commercial/guides/effective-exterior-waterproofing-methods-for-your-property/" },
];
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Protect Your Building's Exterior" />
    </>
  );
}
