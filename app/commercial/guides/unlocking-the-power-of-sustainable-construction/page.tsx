...
const breadcrumbItems = [
  ...
  { name: "Unlocking the Power of Sustainable Construction", href: "/commercial/guides/unlocking-the-power-of-sustainable-construction/" },
];
...
export default function Page() {
  return (
    <>
      ...
      <ArticleSchema
        headline="Unlocking the Power of Sustainable Construction"
        ...
        slug="/commercial/guides/unlocking-the-power-of-sustainable-construction/"
      />
      <FAQSchema faqs={faqs} />
      {/* Hero */}
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Ready to Unlock Sustainable Construction Power?" />
    </>
  );
}
