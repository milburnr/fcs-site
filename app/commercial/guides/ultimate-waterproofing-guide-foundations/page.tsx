...
const breadcrumbItems = [
  ...
  { name: "Ultimate Waterproofing Guide Foundations", href: "/commercial/guides/ultimate-waterproofing-guide-foundations/" },
];

const internalLinks = [
  { href: "/exterior-waterproofing/", label: "Exterior Waterproofing" },
  { href: "/commercial/guides/guide-to-waterproofing-solutions-for-basements/", label: "Basement Waterproofing" },
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Protect Your Building's Foundation" />
    </>
  );
}
