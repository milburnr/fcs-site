...
const breadcrumbItems = [
  ...
  { name: "Enhanced Office Building Security", href: "/commercial/guides/expert-insights-on-ways-t0-enhanced-office-building-security/" },
];

const internalLinks = [
  { href: "/services/commercial/tenant-improvements/", label: "Tenant Improvements" },
  { href: "/commercial/guides/employee-communication-with-office-layout/", label: "Office Layout Design" },
  { href: "/commercial/guides/boosting-performance-in-florida-offices-windows/", label: "Office Windows" },
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Ready to Enhance Your Building's Security?" />
    </>
  );
}
