...
const breadcrumbItems = [
  ...
  { name: "Avoid Commercial Construction Delays in Florida", href: "/commercial/guides/avoid-commercial-construction-delays-in-florida/" },
];
...
const internalLinks = [
  ...
  { href: "/commercial/guides/construction-project-management-and-scheduling/", label: "Project Management" },
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Start Your Project on the Right Foot" />
    </>
  );
}
