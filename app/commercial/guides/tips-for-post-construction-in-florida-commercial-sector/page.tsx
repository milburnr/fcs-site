...
const breadcrumbItems = [
  ...
  { name: "Tips for Post Construction in Florida Commercial Sector", href: "/commercial/guides/tips-for-post-construction-in-florida-commercial-sector/" },
];

const internalLinks = [
  { href: "/commercial/", label: "Commercial Construction Services" },
  { href: "/commercial/guides/florida-construction-specialists-mastering-your-post-construction-checklist/", label: "Post-Construction Checklist" },
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Need Help with Post-Construction Closeout?" />
    </>
  );
}
