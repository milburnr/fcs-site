...
const breadcrumbItems = [
  ...
  { name: "Mall Revamp Construction Ideas", href: "/commercial/guides/commercial-construction-ideas-for-mall-revamp/" },
];
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Ready to Reimagine Your Retail Property?" />
    </>
  );
}
