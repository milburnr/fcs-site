...
const breadcrumbItems = [
  ...
  { name: "Streamlining Your Design Build Project Timeline", href: "/commercial/guides/streamlining-your-design-build-project-timeline/" },
];
...
const internalLinks = [
  ...
  { href: "/commercial/guides/the-preconstruction-modern-approach-design/", label: "Modern Preconstruction" },
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Ready to Accelerate Your Project Timeline?" />
    </>
  );
}
