...
const breadcrumbItems = [
  ...
  { name: "Waterproofing Commercial Contractors", href: "/commercial/guides/waterproofing-commercial-contractors/" },
];
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Partner with Expert Commercial Waterproofing Contractors" />
    </>
  );
}
