...
const breadcrumbItems = [
  ...
  { name: "Tampa's Premier Commercial Remodeling Contractors", href: "/commercial/guides/tampas-premier-commercial-remodeling-contractors/" },
];
...
const internalLinks = [
  ...
  { href: "/commercial/guides/key-signs-your-commercial-remodel-needs/", label: "Signs You Need a Remodel" },
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Ready to Work with Tampa's Best Commercial Contractor?" />
    </>
  );
}
