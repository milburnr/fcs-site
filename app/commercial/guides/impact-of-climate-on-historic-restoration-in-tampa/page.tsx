...
const breadcrumbItems = [
  ...
  { name: "Impact of Climate on Historic Restoration in Tampa", href: "/commercial/guides/impact-of-climate-on-historic-restoration-in-tampa/" },
];
...
export default function Page() {
  return (
    <>
      ...
      <ArticleSchema
        headline="Impact of Climate on Historic Restoration in Tampa"
        description="Learn how Tampa"
        datePublished="2024-01-01"
        slug="/commercial/guides/impact-of-climate-on-historic-restoration-in-tampa/"
      />
      <FAQSchema faqs={faqs} />
      {/* Hero */}
