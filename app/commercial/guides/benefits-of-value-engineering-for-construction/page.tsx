...
const breadcrumbItems = [
  ...
  { name: "Benefits of Value Engineering for Construction", href: "/commercial/guides/benefits-of-value-engineering-for-construction/" },
];

const internalLinks = [
  { href: "/commercial/guides/decoding-value-engineering-florida-construction-expertise/", label: "Value Engineering Deep Dive" },
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Ready to Maximize Your Construction Value?" />
    </>
  );
}
