...
const breadcrumbItems = [
  ...
  { name: "Waterproofing Solutions for Homes", href: "/commercial/guides/waterproofing-solutions-for-homes-the-ultimate-guide/" },
];
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Protect Your Building with Professional Waterproofing" />
    </>
  );
}
