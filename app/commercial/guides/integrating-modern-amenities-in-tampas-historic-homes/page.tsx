...
const breadcrumbItems = [
  ...
  { name: "Integrating Modern Amenities in Tampa's Histori...", href: "/commercial/guides/integrating-modern-amenities-in-tampas-historic-homes/" },
];
...
export default function Page() {
  return (
    <>
      ...
      <ArticleSchema
        headline="Modern Amenities in Tampa Historic Homes | FCS"
        description="Expert integration of modern amenities in Tampa"
        datePublished="2024-01-01"
        slug="/commercial/guides/integrating-modern-amenities-in-tampas-historic-homes/"
      />
      {/* Hero */}
