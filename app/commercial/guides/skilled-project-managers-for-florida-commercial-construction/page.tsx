...
const breadcrumbItems = [
  ...
  { name: "Skilled Project Managers for Florida Commercial Construction", href: "/commercial/guides/skilled-project-managers-for-florida-commercial-construction/" },
];
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Experience the Difference Skilled Project Management Makes" />
    </>
  );
}
