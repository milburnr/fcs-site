...
export const metadata: Metadata = {
  ...
  description: "Preferred Commercial General Contractors in Tampa: expert project management, design-build, and renovations. CBC1262722, 40+ years.",
  openGraph: {
    title: "Preferred Commercial General Contractors in Tampa",
    description: "Preferred Commercial General Contractors in Tampa: expert project management, design-build, and renovations. CBC1262722, 40+ years.",
    url: "https://floridaconstructionspecialists.com/commercial/guides/the-preferred-commercial-general-contractors-in-tampa/",
    type: "website",
...
const breadcrumbItems = [
  ...
  { name: "Preferred Commercial General Contractors in Tampa", href: "/commercial/guides/the-preferred-commercial-general-contractors-in-tampa/" },
];
...
export default function Page() {
  return (
    <>
      ...
      <ArticleSchema
        headline="Preferred Commercial General Contractors in Tampa"
        ...
        slug="/commercial/guides/the-preferred-commercial-general-contractors-in-tampa/"
      />
      <FAQSchema faqs={faqs} />
      {/* Hero */}
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Join Our Satisfied Clients" />
    </>
  );
}
