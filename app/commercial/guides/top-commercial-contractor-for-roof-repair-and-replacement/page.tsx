...
const breadcrumbItems = [
  ...
  { name: "Top Commercial Contractor for Roof Repair and Replacement", href: "/commercial/guides/top-commercial-contractor-for-roof-repair-and-replacement/" },
];
...
const internalLinks = [
  { href: "/commercial/guides/commercial-roofing-services-in-tampa/", label: "Commercial Roofing Services" },
...
export default function Page() {
  return (
    <>
      ...
      {/* Final CTA */}
            <GuideCTA silo="commercial" heading="Tampa Bay's Commercial Roofing Experts" />
    </>
  );
}
