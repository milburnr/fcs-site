...
const breadcrumbItems = [
  ...
  { name: "The Crucial Importance of Customer Satisfaction in Florida Commercial Construction", href: "/commercial/guides/the-crucial-importance-of-customer-satisfaction-in-florida-commercial-construction/" },
];
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Experience the Florida Construction Specialists Difference" />
    </>
  );
}
