...
const breadcrumbItems = [
  ...
  { name: "Hidden Commercial Construction Costs in Florida", href: "/commercial/guides/unveiling-floridas-top-hidden-commercial-construction-costs/" },
];

const internalLinks = [
  { href: "/commercial/guides/decoding-commercial-construction-costs/", label: "Construction Cost Guide" },
  { href: "/commercial/guides/financial-planning-for-commercial-construction/", label: "Financial Planning Guide" },
  { href: "/commercial/guides/construction-quotes-for-commercial-project/", label: "Understanding Quotes" },
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Get a Complete Cost Picture" />
    </>
  );
}
