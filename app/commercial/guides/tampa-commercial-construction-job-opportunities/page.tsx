...
const breadcrumbItems = [
  ...
  { name: "Tampa Commercial Construction Job Opportunities", href: "/commercial/guides/tampa-commercial-construction-job-opportunities/" },
];
...
export default function Page() {
  return (
    <>
      ...
      <ArticleSchema
        headline="Tampa Commercial Construction Job Opportunities"
        description="Explore top Tampa Commercial Construction Job Opportunities. Find the latest job openings in the Tampa construction industry. Your dream job is here!"
        datePublished="2024-01-01"
        slug="/commercial/guides/tampa-commercial-construction-job-opportunities/"
      />
      {/* Hero */}
