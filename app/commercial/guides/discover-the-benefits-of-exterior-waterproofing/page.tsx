...
export const metadata: Metadata = {
  ...
  description: "Learn how exterior waterproofing protects Tampa Bay high-rises from structural damage, lowers long-term costs, and passes inspections. Insights from FCS, licensed CBC.",
  openGraph: {
    title: "Benefits of Exterior Waterproofing Tampa Bay",
...
const breadcrumbItems = [
  ...
  { name: "Benefits of Exterior Waterproofing", href: "/commercial/guides/discover-the-benefits-of-exterior-waterproofing/" },
];
...
const internalLinks = [
  ...
  { href: "/commercial/guides/choosing-the-right-waterproofing-solution-your-ultimate-guide/", label: "Waterproofing Selection Guide" },
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Start Protecting Your Building Today" />
    </>
  );
}
