...
const breadcrumbItems = [
  ...
  { name: "Commercial Interior Design in Tampa", href: "/commercial/guides/commercial-interior-design-in-tampa/" },
];
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          ...
          />
            ...
            <GuideCTA silo="commercial" heading="Ready to Transform Your Commercial Space?" />
    </>
  );
}
