...
export const metadata: Metadata = {
  title: "Commercial Residential Construction in Florida - Florida Construction Specialists",
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto prose prose-lg">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Exploring the Commercial Construction Industry in Florida A Comprehensive Guide
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                The Role of Construction Specialists in the Tampa Area Key Insights
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Navigating Building Codes and Permits for Commercial Construction in Florida
              </h2>
              <p className="text-gray-600 mb-6">
