...
export default function InsuranceRestorationLakelandPage() {
  return (
    <>
      ...
      {/* Internal Links */}
      <RelatedServiceLocations currentCity="Lakeland" currentService="insurance-restoration" currentServiceName="Insurance Restoration" />
    ...
    <RelatedArticles pageSlug="insurance-restoration-lakeland" />
    </>
  );
}
