...
export const metadata: Metadata = {
  title: "Historical Commercial Construction in Tampa - Florida Construction Specialists",
  description: "Specializing in historical commercial construction in Tampa, we blend preservation with modern commercial development, restoring the past for the future.",
};
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="container-custom text-center text-white relative z-10">
          ...
          <p className="text-xl max-w-3xl mx-auto text-gray-200">
            Specializing in historical commercial construction in Tampa, we blend preservation with modern commercial development, restoring the past for the futu
          </p>
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto prose prose-lg">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Architectural Styles in Tampa Exploring the Rich Architectural Heritage
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Tampas Historic Buildings Preserving the Past for Future Generations
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Construction Techniques of Historical Buildings in Tampa Unveiling the Secrets
              </h2>
              <p className="text-gray-600 mb-6">
