...
export const metadata: Metadata = {
  title: "Top Commercial Contractor with Quality Control - Florida Construction Specialists",
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto prose prose-lg">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Ensuring Quality Control in Commercial Construction Projects
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Adhering to Construction Standards in the Tampa Area
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Key Considerations for Commercial Construction in Florida
              </h2>
              <p className="text-gray-600 mb-6">
