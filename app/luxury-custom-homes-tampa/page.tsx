...
export default function LuxuryCustomHomesTampaPage() {
  return (
    <>
      ...
      {/* Internal Links */}
      <RelatedServiceLocations currentCity="Tampa" currentService="luxury-custom-homes" currentServiceName="Luxury Custom Homes" />
    ...
    <RelatedArticles pageSlug="luxury-custom-homes-tampa" />
    </>
  );
}
