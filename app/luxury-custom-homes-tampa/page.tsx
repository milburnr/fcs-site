...
export const metadata: Metadata = {
  ...
  title: "Luxury Custom Homes Tampa FL | Waterfront & Estate Construction | FCS",
  description: "Luxury custom home construction in Tampa. Waterfront estates, Davis Islands, Culbreath Isles, Beach Park, Palma Ceia. Licensed CBC, 40+ years experience in high-end residential.",
};
