...
export default function MultiFamilyConstructionSarasotaPage() {
  return (
    <>
      ...
      {/* Internal Links */}
      <RelatedServiceLocations currentCity="Sarasota" currentService="multi-family-construction" currentServiceName="Multi-Family Construction" />
    ...
    <RelatedArticles pageSlug="multi-family-construction-sarasota" />
    </>
  );
}
