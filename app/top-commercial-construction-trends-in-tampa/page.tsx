...
export const metadata: Metadata = {
  title: "Top Commercial Construction Trends in Tampa - Florida Construction Specialists",
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto prose prose-lg">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Benefits of sustainable building practices in Florida commercial construction
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Enhancing commercial building efficiency in Florida with green construction methods
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Importance of efficient design in Florida commercial construction projects
              </h2>
              <p className="text-gray-600 mb-6">
