...
export const metadata: Metadata = {
  title: "Multi-Family Residential Construction | Condos, Apartments & Townhomes | Florida Construction Specialists",
...
const faqs = [
  {
    ...
    "answer": "FCS specializes in condominium construction, apartment complexes, townhome developments, senior living facilities, student housing, and mixed-use residential projects."
  },
  {
    "question": "Do you handle condo and apartment construction?",
    "answer": "Yes, multi-family residential construction is one of our core specialties. We build both for-sale condominiums and for-rent apartment communities."
  },
  {
    "question": "What is the typical project value for multi-family?",
    "answer": "Our multi-family projects typically range from $1 million for smaller developments to $25 million or more for large complexes."
  },
  {
    "question": "How do you handle common area construction?",
    "answer": "We construct all common areas including lobbies, fitness centers, pools, clubhouses, parking structures, and outdoor amenity spaces."
  },
  {
    "question": "Do you offer balcony waterproofing?",
    "answer": "Yes, balcony construction and waterproofing is included in all our multi-family projects, critical in Florida's climate."
  }
];
  ...
  return (
    <>
      ...
      <ServiceSchema
        ...
        serviceDescription="Expert multi-family construction throughout Tampa Bay. We build condominiums, apartment complexes, townhomes, and mixed-use developments."
        minPrice="1000,000"
      />
        ...
        <div className="container-custom relative z-10">
          <div className="max-w-4xl">
            <div className="inline-block px-4 py-2 bg-brand-gold/20 rounded-full mb-4">
              <span className="text-brand-gold font-semibold">Condos, Apartments & Townhomes</span>
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 font-heading">
              Multi-Family Residential Construction
            </h1>
            <p className="text-xl text-gray-200 mb-8 max-w-2xl">
              Expert multi-family construction throughout Tampa Bay. We build condominiums, apartment complexes, townhomes, and mixed-use developments.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-brand-green-dark mb-6 font-heading">
                Expert Multi-Family Construction Services
              </h2>
              <p className="text-gray-600 mb-6">
                Florida Construction Specialists delivers comprehensive multi-family construction services
              ...
              <p className="text-gray-600 mb-6">
                ...
                and resources needed for projects ranging from $1,000,000 to $25 million or more.
              </p>
              <Link
                href="/contact/"
            ...
            <div className="bg-brand-green-bg rounded-2xl p-8">
              <h3 className="text-xl font-bold text-brand-green-dark mb-6">
                Our Multi-Family Construction Services Include:
              </h3>
      ...
      <section className="section bg-white">
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-bold text-brand-green-dark mb-6 font-heading">
              Why Choose FCS for Multi-Family Construction?
            </h2>
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            ...
            <div className="card text-center p-6">
              ...
              <p className="text-gray-600">Specializing in projects from $1,000,000 to $25M+.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* FAQ */}
      <FAQWithSchema items={faqs} title="Multi-Family Construction FAQs" />

      {/* CTA */}
      <section className="section bg-brand-green">
        <div className="container-custom text-center">
          <h2 className="text-3xl font-bold text-white mb-4 font-heading">
            Ready to Start Your Multi-Family Construction Project?
          </h2>
