...
export const metadata: Metadata = {
  title: "The Impact of Steel and Aluminum Tariffs on Construction - Florida Construction Specialists",
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto prose prose-lg">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                The Impact of Steel and Aluminum Tariffs on Commercial Construction in Florida
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Commercial Development in Florida Affected by Steel and Aluminum Tariffs
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Steel and Aluminum Tariffs in Construction Projects in Florida
              </h2>
              <p className="text-gray-600 mb-6">
