...
export const metadata: Metadata = {
  title: "Water Damage Restoration Insurance Claims in Tampa - Florida Construction Specialists",
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto prose prose-lg">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                How to navigate the claims process for water damage restoration in Tampa
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Understanding the importance of filing insurance claims for water damage in Tampa
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Key factors to consider when assessing water damage for insurance claims in Tampa
              </h2>
              <p className="text-gray-600 mb-6">
