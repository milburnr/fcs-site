...
export const metadata: Metadata = {
  title: "Choosing a Builder Expert Commercial Construction in Tampa - Florida Construction Specialists",
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto prose prose-lg">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Florida Construction Specialists Your Partner in Commercial Building
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Expertise and Experience Tampas Top Commercial Contractor
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Ensuring Quality and Compliance in the Florida Construction Industry
              </h2>
              <p className="text-gray-600 mb-6">
