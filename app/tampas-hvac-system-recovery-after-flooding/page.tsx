...
const breadcrumbItems = [
  { name: "Home", href: "/" },
  { name: "Tampa's Hvac System Recovery After Flooding", href: "/tampas-hvac-system-recovery-after-flooding/" },
];
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="container-custom text-center text-white relative z-10">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 font-heading">
            Tampa’s HVAC System Recovery After Flooding
          </h1>
          <p className="text-xl max-w-3xl mx-auto text-gray-200">
            Restore your comfort with Tampa&apos;s HVAC System Recovery After Flooding.We specialize in restoring flood-damaged HVAC units to get your home back to cli
          </p>
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto prose prose-lg">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Importance of HVAC Repair Services in Tampa After Flooding
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Flood Damage Restoration for HVAC Systems in Tampa
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Water Damage Recovery Restoring HVAC System Functionality
              </h2>
              <p className="text-gray-600 mb-6">
