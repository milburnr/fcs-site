...
export const metadata: Metadata = {
  title: "Historic Restoration Projects in Tampa - Florida Construction Specialists",
  description: "Looking for historic restoration projects in Tampa? Discover our expert preservation and renovation services for historic buildings in Tampa. Call now!",
};
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="container-custom text-center text-white relative z-10">
          ...
          <p className="text-xl max-w-3xl mx-auto text-gray-200">
            Looking for historic restoration projects in Tampa? Discover our expert preservation and renovation services for historic buildings in Tampa. Call now
          </p>
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto prose prose-lg">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Transforming Tampas Historic Buildings A Showcase of Preservation Projects
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                The Art of Unveiling Tampas Historic Restoration Showcase
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Bringing the Past to Life Exploring Renovated Historic Sites in Tampa
              </h2>
              <p className="text-gray-600 mb-6">
