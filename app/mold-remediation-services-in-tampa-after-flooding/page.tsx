...
export const metadata: Metadata = {
  title: "Mold Remediation Services in Tampa After Flooding - Florida Construction Specialists",
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto prose prose-lg">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Immediate Water Damage Restoration After Flooding
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Understanding the Dangers of Mold Growth After a Flood
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                How Moisture Control Can Prevent Mold Infestation in Tampa
              </h2>
              <p className="text-gray-600 mb-6">
