...
export default function LuxuryCustomHomesClearwaterPage() {
  return (
    <>
      ...
      {/* Internal Links */}
      <RelatedServiceLocations currentCity="Clearwater" currentService="luxury-custom-homes" currentServiceName="Luxury Custom Homes" />
    ...
    <RelatedArticles pageSlug="luxury-custom-homes-clearwater" />
    </>
  );
}
