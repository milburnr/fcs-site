...
export const metadata: Metadata = {
  ...
  description: "Multi Family Construction in Lakeland: new construction, renovations, and insurance restoration. FL-licensed CBC contractor. Call (813) 420-7561 for a quote.",
};
