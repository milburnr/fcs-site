...
export const metadata: Metadata = {
  title: "Custom Commercial Construction Solutions in Tampa - Florida Construction Specialists",
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto prose prose-lg">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Customized Construction Solutions for Specialized Business Owners in Tampa
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Factors to Consider When Choosing a Commercial Builder for Construction Projects in Tampa
              </h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-bold text-brand-green-dark mb-4 font-heading">
                Meeting Specific Construction Needs of Specialized Business Owners in Tampa
              </h2>
              <p className="text-gray-600 mb-6">
