...
const breadcrumbItems = [
  ...
  { name: "Tampa Custom Homes with Unique Facades", href: "/residential/guides/tampa-custom-homes-with-unique-facades/" },
];
...
export default function Page() {
  return (
    <>
      ...
      {/* CTA */}
            <GuideCTA silo="residential" heading="Ready to Create a Distinctive Facade?" />
    </>
  );
}
