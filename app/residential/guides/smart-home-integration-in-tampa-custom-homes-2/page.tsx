...
const breadcrumbItems = [
  ...
  { name: "Smart Home Integration in Tampa Custom Homes", href: "/residential/guides/smart-home-integration-in-tampa-custom-homes-2/" },
];
...
export default function Page() {
  return (
    <>
      ...
      {/* CTA */}
            <GuideCTA silo="residential" heading="Ready to Build a Smart Custom Home?" />
    </>
  );
}
