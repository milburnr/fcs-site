...
export const metadata: Metadata = {
  ...
  description: "Design unique luxury bedrooms in your Tampa custom home. Spa-inspired master suites custom closets sitting areas.",
  openGraph: {
    title: "Unique Bedrooms in Tampa Custom Homes | Luxury",
    description: "Design unique luxury bedrooms in your Tampa custom home. Spa-inspired master suites custom closets sitting areas.",
    url: "https://floridaconstructionspecialists.com/residential/guides/creating-unique-bedrooms-in-tampa-custom-homes/",
    type: "website",
...
const breadcrumbItems = [
  ...
  { name: "Creating Unique Bedrooms in Tampa Custom Homes", href: "/residential/guides/creating-unique-bedrooms-in-tampa-custom-homes/" },
];

const internalLinks = [
  { href: "/residential/guides/tampa-custom-homes-with-luxury-bathrooms/", label: "Luxury Bathroom Design" },
...
export default function Page() {
  return (
    <>
      ...
      {/* CTA */}
            <GuideCTA silo="residential" heading="Ready to Create Your Dream Master Suite?" />
    </>
  );
}
