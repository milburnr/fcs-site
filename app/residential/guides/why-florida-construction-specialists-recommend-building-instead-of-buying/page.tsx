...
const breadcrumbItems = [
  ...
  { name: "Why We Recommend Building Instead of Buying", href: "/residential/guides/why-florida-construction-specialists-recommend-building-instead-of-buying/" },
];
...
export default function Page() {
  return (
    <>
      ...
      {/* Final CTA */}
            <GuideCTA silo="residential" heading="Build Your Perfect Commercial Space" />
    </>
  );
}
