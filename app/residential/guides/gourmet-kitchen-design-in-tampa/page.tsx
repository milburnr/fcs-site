...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://floridaconstructionspecialists.com/residential/guides/gourmet-kitchen-design-in-tampa/",
    type: "website",
...
const breadcrumbItems = [
  ...
  { name: "Gourmet Kitchen Design in Tampa", href: "/residential/guides/gourmet-kitchen-design-in-tampa/" },
];
...
export default function Page() {
  return (
    <>
      ...
      {/* CTA */}
            <GuideCTA silo="residential" heading="Ready to Design Your Gourmet Kitchen?" />
    </>
  );
}
