...
const breadcrumbItems = [
  ...
  { name: "Preventing Home Improvement Fraud", href: "/residential/guides/preventing-home-improvement-fraud/" },
];
...
export default function Page() {
  return (
    <>
      ...
      {/* Final CTA */}
            <GuideCTA silo="residential" heading="Licensed, Insured, Trusted" />
    </>
  );
}
