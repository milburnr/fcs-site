...
const breadcrumbItems = [
  ...
  { name: "Tampa Luxury Custom Home Building Services", href: "/residential/guides/tampa-luxury-custom-home-building-services/" },
];
...
export default function Page() {
  return (
    <>
      ...
      <ArticleSchema
        headline="Tampa Luxury Custom Home Building Services | Premier Builder"
        description="Premier luxury custom home building services in Tampa. Bespoke designs, premium materials, white-glove service. Award-winning craftsmanship from $600K-
      <BreadcrumbSchema items={breadcrumbItems} />0M+."
        datePublished="2024-01-01"
        slug="/residential/guides/tampa-luxury-custom-home-building-services/"
      />
      <FAQSchema faqs={faqs} />
      {/* Hero */}
      ...
      {/* CTA */}
            <GuideCTA silo="residential" heading="Ready to Build Your Luxury Dream Home?" />
    </>
  );
}
