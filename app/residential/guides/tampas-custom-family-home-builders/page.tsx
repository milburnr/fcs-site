...
const breadcrumbItems = [
  ...
  { name: "Tampa's Custom Family Home Builders", href: "/residential/guides/tampas-custom-family-home-builders/" },
];

const internalLinks = [
  { href: "/residential/", label: "Residential Construction Services" },
  { href: "/residential/guides/custom-home-accessibility-features-in-tampa/", label: "Accessibility Features" },
...
export default function Page() {
  return (
    <>
      ...
      <ArticleSchema
        headline="Tampa"
        description="Build your family"
        datePublished="2024-01-01"
        slug="/residential/guides/tampas-custom-family-home-builders/"
      />
      <FAQSchema faqs={faqs} />
      {/* Hero */}
      ...
      {/* CTA */}
            <GuideCTA silo="residential" heading="Ready to Build Your Family's Dream Home?" />
    </>
  );
}
