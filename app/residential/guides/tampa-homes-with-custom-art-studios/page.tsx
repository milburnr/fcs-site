...
const breadcrumbItems = [
  ...
  { name: "Tampa Homes with Custom Art Studios", href: "/residential/guides/tampa-homes-with-custom-art-studios/" },
];

const internalLinks = [
  { href: "/residential/", label: "Residential Construction Services" },
  { href: "/residential/guides/tampa-custom-home-builders-with-artistic-flair/", label: "Custom Homes with Artistic Flair" },
...
export default function Page() {
  return (
    <>
      ...
      <ArticleSchema
        headline="Tampa Homes with Custom Art Studios | Creative Spaces"
        description="Build custom homes with dedicated art studios in in Tampa. Professional advice from FCS, serving clients since 1982. Call for a free consultation today."
        datePublished="2024-01-01"
        slug="/residential/guides/tampa-homes-with-custom-art-studios/"
      />
      <FAQSchema faqs={faqs} />
      {/* Hero */}
      ...
      {/* CTA */}
            <GuideCTA silo="residential" heading="Ready to Build Your Creative Space?" />
    </>
  );
}
